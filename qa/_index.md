...
| 상세          | `/hotpick/{slug}` | [checklist.md](detail/checklist.md)       | [detail.spec.ts](detail/detail.spec.ts), [like.spec.ts](detail/like.spec.ts), [vote-trend.spec.ts](detail/vote-trend.spec.ts)                                  | [detail.md](../docs/specs/pages/detail.md)             | -       |
