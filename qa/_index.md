...
| ------------- | ----------------- | ----------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------ | ------- |
| 메인          | `/`               | [checklist.md](main/checklist.md)         | [main.spec.ts](main/main.spec.ts), [share.spec.ts](main/share.spec.ts), [comment.spec.ts](main/comment.spec.ts)                               | [main.md](../docs/specs/pages/main.md)                 | -       |
