...
export const singleVoteDataMap: Record<string, MockSingleVote> = {
  'single-love': {
    electionId: 's1',
    options: [
      { id: 's1-o1', text: '분위기 좋은 카페', voteCount: 230 },
      { id: 's1-o2', text: '놀이공원', voteCount: 190 },
    ],
    voted: true,
    myChoiceId: 's1-o1',
    totalVotes: 420,
  ...
  'single-text-finance': {
    electionId: 'st1',
    options: [
      { id: 'st1-o1', text: '안전한 적금', voteCount: 410 },
  ...
  'single-work': {
    electionId: 'sw1',
    options: [
      { id: 'sw1-o1', text: '재택근무', voteCount: 380 },
      { id: 'sw1-o2', text: '사무실 출근', voteCount: 290 },
    ],
    voted: true,
    myChoiceId: 'sw1-o1',
    totalVotes: 670,
  ...
  'single-chicken': {
    electionId: 'sc1',
    options: [
      { id: 'sc1-o1', text: '후라이드', voteCount: 340 },
      { id: 'sc1-o2', text: '양념', voteCount: 420 },
      { id: 'sc1-o3', text: '반반', voteCount: 200 },
    ],
    voted: true,
    myChoiceId: 'sc1-o2',
    totalVotes: 960,
  ...
  'single-movie': {
    electionId: 'smv1',
    options: [
      { id: 'smv1-o1', text: '극장', voteCount: 480 },
      { id: 'smv1-o2', text: 'OTT', voteCount: 440 },
    ],
    voted: true,
    myChoiceId: 'smv1-o2',
    totalVotes: 920,
  ...
  'single-beer': {
    electionId: 'sbr1',
    options: [
      { id: 'sbr1-o1', text: '맥주', voteCount: 2200 },
      { id: 'sbr1-o2', text: '소주', voteCount: 2000 },
      { id: 'sbr1-o3', text: '와인', voteCount: 1500 },
      { id: 'sbr1-o4', text: '위스키', voteCount: 800 },
    ],
    voted: true,
    myChoiceId: 'sbr1-o1',
    totalVotes: 6500,
