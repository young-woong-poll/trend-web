import type {
  MainDisplayResponse,
  HotpickDisplayResponse,
  HotpickVoteCountResponse,
} from '@/types/hotpick';
 ...
 * Hotpick 전시 Mock 데이터
 */
export const mockHotpickDisplay: HotpickDisplayResponse = {
  hotpickId: 'love',
  alias: 'love',
  title: '대한민국 연애 난제',
...
/**
 * Hotpick 투표 수 Mock 데이터
 */
export const mockHotpickVoteCount: HotpickVoteCountResponse = {
  options: [
    { id: 'q1-o1', count: 450 },
    { id: 'q1-o2', count: 750 },
    { id: 'q2-o1', count: 680 },
