...
const FAQ_ITEMS = [
  ...
  {
    question: '가치관 비교가 뭔가요?',
    answer:
      '하나의 주제로 묶인 5~10개 질문 팩이에요. 결혼 가치관, 직장인 생존 같은 테마별로 구성되어 있고, 모두 답한 뒤 친구·연인과 생각을 비교할 수 있어요.',
  },
  {
    question: '가치관 비교는 로그인 없이도 할 수 있나요?',
    answer:
      '테스트 소개 페이지는 누구나 볼 수 있지만, 참여와 결과 확인은 로그인이 필요해요. 카카오 로그인으로 간편하게 시작할 수 있습니다.',
  },
  {
    question: '가치관 비교는 몇 명까지 함께 할 수 있나요?',
    answer:
      '한 테스트에 최대 50명까지 함께 참여할 수 있어요. 둘이서 시작해도 친구가 추가될 때마다 관계도 그래프, 그룹 비교 분석이 더 풍부해져요.',
  },
  {
    question: '일치 등급은 어떻게 정해지나요?',
    answer:
  ...
  {
    question: '가치관 비교 답변을 수정하거나 다시 할 수 있나요?',
    answer:
      '답변은 수정할 수 없어요. 비교 결과의 신뢰성을 위해 한 번 제출하면 확정됩니다. 신중하게 골라주세요!',
  },
];
